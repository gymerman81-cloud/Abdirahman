...
public class evc{
    public static void main() {
        ...
        menu.add("7. taaj");
        menu.add("8. Maareynta");
        menu.add("9. Biil Payment");
...
//                    SOO LAABASHO WEEEYE QEYBTAAN
    ...
    public static void taaj() {
        ...
        System.out.println("\n--- TAAJ SYSTEM ---");
        System.out.println("1. Dir Lacag (Send Money)");
        System.out.println("2. Qaado Lacag (Receive)");
        System.out.print("Dooro: ");
        ...
        switch (choice) {
            ...
            default:
                System.out.println("Doorasho khalad ah");
        }
    }
    ...
    public static void sendTaaj() {
        Scanner input=new Scanner(System.in);
        int PIN=12345;
        double balance=1000;

        System.out.print("Geli number-ka qaataha: ");
        ...
        System.out.print("Ma hubtaa inaad $" + lacag + " u dirto " + number + "? (1=Haa / 2=Maya): ");
        ...
        if (confirm == 1) {
            ...
            if (pin == PIN) {
                ...
                if (lacag <= balance) {
                    ...
                    System.out.println("✔ TAAJ SUCCESS");
                    System.out.println("Lacag: $" + lacag);
            ...
            System.out.println("La joojiyey");
        }

        System.out.print("Geli reference number: ");
        String ref = input.nextLine();
//
//        System.out.print("Geli lacagta la helay: ");
//        double lacag = input.nextDouble();
//        input.nextLine();

        balance += lacag;

        System.out.println("✔ Lacag la helay");
        System.out.println("Reference: " + ref);
        System.out.println("Amount: $" + lacag);
        System.out.println("Haraaga cusub: $" + balance);
    }
    public static void receiveTaaj() {
        Scanner input=new Scanner(System.in);
        int balance=1000;
